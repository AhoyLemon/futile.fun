...
var rockFellMessages = ["Oops!", "Uh oh!", "Damn it!", "The rock fell.", "Oh no.", "Crap!"];

var retreatMessages = ["Go back and get it!", "Guess you'll have to go back.", "Back down to the bottom.", "Maybe next time.", "No problem! Just go back.", "Go back down the hill."];
